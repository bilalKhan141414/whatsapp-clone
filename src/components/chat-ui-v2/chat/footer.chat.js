...
import { AudioRecorderContainer } from "./audio-recorder/audio-recorder-container";
...
const ChatFooter = ({ isMobileView }) => {
  ...
  const { startRecording, toggleRecording } = useChatContext();
  return (
    <div className='relative'>
      ...
      <form
        ...
        className={`bg-grey-lighter px-4 py-4 flex items-center ${
          startRecording ? "justify-end gap-3" : ""
        }`}>
        {startRecording ? (
          <>
